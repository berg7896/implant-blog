  ...
  return (
    <footer className="bg-brand-dark text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* About */}
        <div>
          <h3 className="text-white font-bold text-lg mb-4">Implant Center of Coral Springs</h3>
          <p className="text-sm leading-relaxed mb-4">
            Expert dental implant care with board-certified specialists, Yomi Robot technology, 
            and an in-house laboratory. Serving South Florida with 6 convenient locations.
          </p>
          <p className="text-sm">
